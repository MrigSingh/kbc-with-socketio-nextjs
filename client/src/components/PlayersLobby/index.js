...
export default function PlayersLobby({ socket, allPlayers, openLobby }) {
		...
		<div>
			...
			>
				<Box sx={style}>
					...
					<div className='mt-5'>
						<Button style={{width: "100%"}} variant="contained" color="success" disabled={Boolean(allPlayers.find(item => item.ready))}>
							Start the game
						</Button>
					</div>
				</Box>
